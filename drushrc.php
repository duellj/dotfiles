...
$options['skip-tables'] = array(
 'common' => array('accesslog', 'cache', 'cache_block', 'cache_content', 'cache_form', 'cache_location', 'cache_uc_price', 'cache_update', 'cache_views', 'cache_views_data', 'cache_filter', 'cache_menu', 'cache_page', 'history', 'search_dataset', 'search_index', 'search_total', 'sessions', 'watchdog'),
);
...
$command_specific['pm-update'] = array(
  # 'backup-dir' => '/Users/jonduell/.drush-backups',
  'no-backup' => TRUE,
);
